...
![]({{site.baseurl}}/assets/images/posts/2020-10_infovis_trrack_teaser.png)
...
You can customize Trrack-Vis with icons and logic to group nodes. Below is an example with custom icons and grouping, based on our [predicting intent project]({{site.base_url}}/publications/2020_preprint_intent/). For more information, see the [documentation](http://vdl.sci.utah.edu/trrack-examples/api/trrack-vis/). 
